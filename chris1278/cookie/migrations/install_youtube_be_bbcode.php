...
class install_youtube_be_bbcode extends \phpbb\db\migration\migration
{
	public static function depends_on()
	{
		return ['\chris1278\cookie\migrations\update_youtube_bbcode'];
	}

	public function update_data()
	{
		return [
			['custom', [[$this, 'installyoutubebebbcode']]],
		];
	}
	...
	{
		return [
			['custom', [[$this, 're_install_youtube_be_bbcode']]],
		];
	}

	public function installyoutubebebbcode($bbcode_data)
	{
		...
		*/
		$bbcode_data = [
			'youtube_bbcode=' => [
				'bbcode_match'			=> '[youtube_be]https://youtu.be/{IDENTIFIER}[/youtube_be]',
				'bbcode_tpl'			=> '<!-- IF YOUTUBE_BBCODE_SWITCH --><div class="yt_video_layer"><iframe width="560" height="315" data-src="https://www.youtube.com/embed/{IDENTIFIER}" data-name="youtube" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div><!-- ELSE --><div class="yt_video_switch_false">{L_YOUTUBE_ADMIN}</div><!-- ENDIF -->',
				'bbcode_helpline'		=> 'YTBE_VIDEOLINK_HELP',
	...
	public function re_install_youtube_be_bbcode($bbcode_data)
	{
		// Load the acp_bbcode class
		if (!class_exists('acp_bbcodes'))
		{
		...
		*/
		$bbcode_data = [
			'youtube_bbcode=' => [
				'bbcode_match'			=> '[youtube_be]https://youtu.be/{IDENTIFIER}[/youtube_be]',
				'bbcode_tpl'			=> '<div"><iframe style="max-width:100%;width:590px; height: 500px;margin-top:3px;height: 350px;" width="560" height="315" src="https://www.youtube.com/embed/{IDENTIFIER}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',
				'bbcode_helpline'		=> '[youtube_be]Videolink[/youtube_be] - For the Youtbe Short Links via https://youtu.be',
				'display_on_posting'	=> 1,
			],
		];
