...
$lang = array_merge($lang, [
	'ACP_CM_SETTINGS_PAGE_TITLE_EXPLAIN'			=> 'Hier können Sie die Einstellungen vornehmen um ihr Skript anzupassen.<br><br>Wählen Sie hier ihre Optionen/Schalter aus welche ihren Besuchern beim Besuch ihres Forums angezeigt werden sollen.<br><br>Für die Verwendung von eigenen Skripten bzw. Skripte für die Schalter welche nur die Ansprechparameter für Skripte bereitstellen, können die folgenden Dateien aus dem Style-Ordner der Erweiterung bearbeitet werden: <br><br><b>%1$s</b> <- Für Skripte oder die Teile der Skripte die am Anfang der Webseite geladen werden müssen! <br><br><b>%2$s</b> <- Für Skripte oder die Teile der Skripte die am Ende der Webseite geladen werden müssen',
	'ACP_CM_SWITCH_SET_TITLE'						=> 'Anzuzeigende Schalter',
	'ACP_COOKIE_IMPRESSUM'							=> 'Impressum für die Infobox des Forums-Schalters',
	'ACP_COOKIE_IMPRESSUM_EXPLAIN'					=> 'Hier können Sie auswählen wie Sie ihr Impressum generieren. Das ist dann der Link der in der Auswahl Box des Cookies in der Infobox für die Essentiellen Cookies des Forums inklusiver Verlinkung eingeblendet wird. Es wird Empfohlen dazu die Extension <a href="https://www.phpbb.com/customise/db/extension/about_us/" target="_blank"><b>About us von Crizzo</b></a> zu nutzen.<br><br><b>Notiz:</b> Diese Einstellung bezieht sich lediglich auf das verlinkte Impressum was in der Box zu dem fix Schalter für die Foren Cookies generiert wird. Dies hat keine Auswirkung auf andere Arten von einem Impressum z.B. about us von Crizzo.',
	'ACP_COOKIE_IMPRESSUM_INTERN_EXTERN'			=> 'Auswahl der Art des genutzten Impressum´s',
	'ACP_COOKIE_IMPRESSUM_INTERN_EXTERN_EXPLAIN'	=> 'Hier können Sie Auswählen was für eine Art Impressum Sie nutzen.',
	'COOKIE_IMPRESSUM_LINK_EXTERN'					=> 'Link für das Impressum',
	'COOKIE_IMPRESSUM_LINK_EXTERN_EXPLAIN'			=> 'Geben Sie hier bitte den vollständigen Link zum Impressum ein.<br><br><b>z.B. https://meine-domain.de/impressum.php</b>',
