...
$lang = array_merge($lang, [
	...
	'WINDOW_POSITION_EXPLAIN'						=>	'Hier kannst du auswählen ob das Hinweisfenster dezent am unteren rechten Bildschirmrand plaziert sein soll, oder ob du das  direkt Mittig öffnen lassen möchtestn. Wenn der Einwilligungsmanager sich direkt öffnet bekommt der Besucher des Forums direkt beim ersten Aufruf ein Auswahlfenster mit Schaltern angezeigt die er wählen kann und Bestätigen muss. Ansonsten kann er das Forum nicht nutzen.<br><br>Standard: <b>"Unten Rechts auf dem Bildschirm" </b>',
	'MIDDLE'										=>	'Mittig auf dem Bildschirm',
	'DOWNRIGHT'										=>	'Unten Rechts auf dem Bildschirm',
	'NAME_OF_COOKIE'								=>	'Name des Cookies',
	'NAME_OF_COOKIE_EXPLAIN'						=>	'Hier kannst Du den Namen des Cookies angeben, unter dem Klaroscript die Einstellungen als Cookie abspeichert.<br><br>Standard: <b>Klaro</b>',
	...
	'KLARO_STYLE_EXPLAIN'							=>	'Hier kannst du auswählen ob du den Klaro Manager in einer Dunkeler Optik haben möchtes oder in einer Hellen Optik.',
	'DARK'											=>	'Dunkel',
	'LIGHT'											=>	'Hell',
	...
	'COOKIE_ICON_SELECTION_EXPLAIN'					=>	'Hier kannst du auswählen, ob du ein SVG-Icon im Fenster anzeigen lassen möchtest oder ein Fontawesome-Icon. Es geht sich bei dem Icon was in dem Fenster wo dann nachher die Schalter aufgelistet sind zu sehen ist. Das Icon in der unteren Navigationsleiste bleibt davon unberührt.',
	'ACP_FONTAWESOME'								=>	'Fontawesome-Icon',
	'ACP_SVG'										=>	'SVG-Icon',
	'SAVE_ALL_BUTTON'								=>	'Button <b>"Alles Speichern"</b> anzeigen',
	'SAVE_ALL_BUTTON_EXPLAIN'						=>	'Mit diesem Schalter kannst Du den Button <b>"Alles Speichern"</b> deaktivieren.<br><br>Standard: <b>Ja - Aktiviert</b>',
	'COOKIE_RUNTIME'								=>	'Cookie-Laufzeit',
	'COOKIE_RUNTIME_EXPLAIN'						=>	'Mit diesem Wert kannst Du angeben wieviele Tage das Cookie welches der Klaromanager setzt Gülltigkeit behält.<br><br>Standard: <b>120</b>	',
	'SHOW_DECLINE_BUTTON'							=>	'Button <b>"Ablehnen"</b> anzeigen',
	'SHOW_DECLINE_BUTTON_EXPLAIN'					=>	'Mit diesem Schalter kannst Du den Button <b>"Ablehnen"</b> deaktivieren.<br><br>Standard: <b>Ja - Aktiviert</b>',
